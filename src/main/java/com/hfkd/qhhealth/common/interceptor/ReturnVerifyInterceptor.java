...
import com.hfkd.qhhealth.common.util.SerializeUtil;
import com.hfkd.qhhealth.config.CacheAopConfig;
 ...
 * todo 考虑至全局异常管理里处理错误数据{@link com.hfkd.qhhealth.config.GlobalExceptionHandler}
 * @author hexq
